...
export const listings: Listing[] = [
  ...
  {
    id: "dewalt-sander",
    title: "Vibrační bruska DeWalt DWE6423",
    price: "190 Kč / den",
    priceValue: 190,
    location: "Praha 2",
    distance: "1.2 km",
    ...
    availability: "K dispozici dnes",
    depositRequired: false,
    description: "Kompaktní bruska pro lakování, broušení dřeva i kovu. Sáček na prach v ceně.",
    owner: "Martin",
    ownerSince: "na platformě 1 rok",
    badges: ["Rychlá odpověď", "Osobní předání", "Ověřený profil"],
    pickupMode: "personal",
    photo: "https://images.unsplash.com/photo-1581244277943-fe4a9c777189?w=600&q=80",
  },
  {
    id: "ladder-8m",
    title: "Hliníkový žebřík 8 m",
    price: "150 Kč / den",
    priceValue: 150,
    location: "Praha 6",
    distance: "2.8 km",
    ...
    rating: 4.5,
    category: "stavba",
    availability: "Volné od zítřka",
    depositRequired: true,
    description: "Stabilní skládací žebřík pro malování, čištění okapů nebo menší fasádní práce.",
    owner: "Karel",
    ownerSince: "na platformě 2 roky",
    badges: ["Kauce online", "Dostupné brzy", "Fotky stavu"],
    pickupMode: "personal",
    photo: "https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=600&q=80",
  },
  {
    id: "jigsaw-bosch",
    title: "Přímočará pila Bosch PST 900",
    price: "130 Kč / den",
    priceValue: 130,
    location: "Olomouc",
    distance: "1.5 km",
    ...
    rating: 4.8,
    category: "dilna",
    availability: "K dispozici ihned",
    depositRequired: false,
    description: "Lehká a přesná pila pro řezání dřeva, plastu i laminátových desek. Sada listů přibalena.",
    owner: "Eva",
    ownerSince: "na platformě 6 měsíců",
    badges: ["Top rating", "Bezpečné předání", "Oblíbené"],
    pickupMode: "personal",
    photo: "https://images.unsplash.com/photo-1530124566582-a618bc2615dc?w=600&q=80",
  },
  {
    id: "compressor-mini",
    title: "Mini kompresor Michelin",
    price: "100 Kč / den",
    priceValue: 100,
    location: "Praha 10",
    distance: "3.6 km",
    ...
    availability: "Na víkend volné",
    depositRequired: false,
    description: "Ideální pro huštění pneumatik, míčů nebo nafukovacích předmětů. Lehký a přenosný.",
    owner: "Petr",
    ownerSince: "na platformě 4 měsíce",
    badges: ["Rychlá odpověď", "Připraveno k půjčení"],
    pickupMode: "personal",
    photo: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80",
  },
];
...
export const conversations: Conversation[] = [
  ...
  },
  {
    ...
    unread: 1,
    lastMessage: "Rezervace zamítnuta",
    lastTime: "Pondělí",
    messages: [
      { id: "m1", type: "message", text: "Dobrý den, byl bych zájem o myčku tento víkend, je volná?", sender: "me", time: "Po 14:00" },
      { id: "m2", type: "message", text: "Dobrý den, myčka je teď obsazená do příštího pátku. Zkuste příští týden.", sender: "them", time: "Po 14:45" },
      { id: "s1", type: "status", statusType: "reservation-sent",      statusText: "Odeslali jste žádost o rezervaci na víkend.", time: "Po 15:00" },
